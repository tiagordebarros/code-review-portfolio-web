        ...
        <div className="row">
          <div className="col-12">
            <div className="skill-bx wow zoomIn">
              <h2>Habilidades</h2>
              <p>
                Abaixo, apresento as principais tecnologias envolvidas na
                elaboração dos projetos.<br></br>São stacks, libraries,
                frameworks e outras ferramentas que eu utilizo no dia a dia.
              </p>
              <Carousel
